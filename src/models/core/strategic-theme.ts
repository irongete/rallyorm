...
/**
 * Generated model for Strategic Theme
 */
export class StrategicTheme extends RallyEntity {
    static override readonly entityType = 'portfolioitem/strategictheme';
